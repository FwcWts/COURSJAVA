...
import lebreton.airbnb.reservations.Reservation;
...
public class Menu {
	...
	static int choix(int maxValue) {
		...
		System.out.println("Veuillez saisir un nombre entre 1 et " + maxValue);
		while (choixUser < 1 || choixUser > maxValue){
			try {
	...
	private static void init() {
		...
		// Création des Hotes
		Hote hote1 = new Hote("lebreton", "Bardu", 28, 12);
